...
navigator.serviceWorker.register(document.write('https://cdn.jsdelivr.net/gh/utkarshv/push_test/firebase-messaging-sw.js'))
    .then((registration) => {
        ...
        function sendTokenToServer({ token, clientId, browserId }) {         
            ...
            .then((res) => { welcomeNotification({containerId: clientId, token: token}); });
        }
